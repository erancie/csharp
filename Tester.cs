    ...
    class Tester
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                vector = new Vector<int>(1); // change from 50 to 1, get this working C,D,F and change back
...
///////////////////////////////////////////////////////////////////
            ...
            // Vector<int> another = new Vector<int>();
            // another.Add(4);
            // another.Add(60);
            // another.Add(300);
            // another.Add(-1);
            ...
            // Console.WriteLine(another.Contains(4));
            // Console.WriteLine(another.Contains(2));
            // Console.WriteLine(another.Contains(300));
            // Console.WriteLine(another[1].ToString());
            ...
            // another.Insert(0, 11);
            // another.Insert(3, 10);
            // Console.WriteLine(another[0].ToString());
            // Console.WriteLine(another[1].ToString());
            // Console.WriteLine(another[2].ToString());
            // Console.WriteLine(another[3].ToString());

            // vector.Insert(vector.Count, 1000);
